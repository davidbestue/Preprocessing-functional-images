...
Runs={'run1', 'run2', 'run3', 'run4', 'run5', 'run6', 'run7', 'run8', 'run9', 'run10', 'run11', 'run12', 'run13'};
...
for r = 1:length(Runs)
    ...
    for i = 1:252
         matlabbatch{1}.spm.spatial.realign.estwrite.data{1}{end+1}= ['/data/davsan/Desktop/Distractor_project/imaging/r001/WMtask/', Runs{r} , '/fmri5_task_Ax.nii,',sprintf('%i',i)]; 
    end
